@include('site/shared/clientes-loader',['carregando' => 'carregando_resolvidos'])
<table ng-if="{{$chamados}}.length != 0 && carregando_resolvidos == false" class="default">
    <tbody>
...
<div class="nenhum-conteudo" ng-if="{{$chamados}}.length == 0 && carregando_resolvidos == false" ng-cloak ng-class="{carregado: true}">
