(function () {
    ...
    function dashboard($scope, API) {
        ...
        function getServicos() {
            API.get('cliente/dashboard/servicos').then(function successCallback(response) {
        ...
        function getChamados() {
            API.get('cliente/dashboard/chamados').then(function successCallback(response) {
        ...
        function getFaturas() {
            API.get('cliente/dashboard/faturas').then(function successCallback(response) {
        ...
        function getContratos() {
            API.get('cliente/dashboard/contratos').then(function successCallback(response) {
